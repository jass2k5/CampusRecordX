...
from input_validators import (is_valid_email,
...
def collect_and_student(manager):
    ...
    # This is the key part - make sure this gets called!
    print(f"DEBUG: About to add student: {name}, {roll}, {course}, {phone}, {email}, {cgpa}")
    manager.add_students(name, roll, course, phone, email, cgpa)
    print(f"DEBUG: Student added! Total students: {len(manager.students)}")
